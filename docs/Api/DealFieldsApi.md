...
```php
addDealField($field_create_request): \Pipedrive\Model\FieldResponse
```
...
```php
deleteDealField($id): \Pipedrive\Model\DeleteResponse
```
...
```php
deleteDealFields($ids): \Pipedrive\Model\BulkDeleteResponse
```
...
```php
getDealField($id): \Pipedrive\Model\FieldResponse
```
...
```php
getDealFields($start, $limit): \Pipedrive\Model\FieldsResponse
```
...
```php
updateDealField($id, $field_update_request): \Pipedrive\Model\FieldResponse
```
