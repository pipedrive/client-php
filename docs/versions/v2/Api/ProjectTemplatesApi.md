# Pipedrive\versions\v2\ProjectTemplatesApi
...
```php
getProjectTemplate($id): \Pipedrive\versions\v2\Model\GetProjectTemplateResponse
```
...
$apiInstance = new Pipedrive\versions\v2\Api\ProjectTemplatesApi(
...
[**\Pipedrive\versions\v2\Model\GetProjectTemplateResponse**](../Model/GetProjectTemplateResponse.md)
...
```php
getProjectTemplates($cursor, $limit): \Pipedrive\versions\v2\Model\GetProjectTemplatesResponse
```
...
[**\Pipedrive\versions\v2\Model\GetProjectTemplatesResponse**](../Model/GetProjectTemplatesResponse.md)
