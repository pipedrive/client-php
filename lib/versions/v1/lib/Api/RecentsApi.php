...
class RecentsApi
{
     ...
     * @return \Pipedrive\versions\v1\Model\GetRecents
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\versions\v1\Model\GetRecents, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    if ('\Pipedrive\versions\v1\Model\GetRecents' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\versions\v1\Model\GetRecents', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Pipedrive\versions\v1\Model\GetRecents',
    ...
    {
        $returnType = '\Pipedrive\versions\v1\Model\GetRecents';
        $request = $this->getRecentsRequest($since_timestamp, $items, $start, $limit);
