...
/**
 * AddFilterRequest Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v1
 * @author   OpenAPI Generator team
 ...
 */
class AddFilterRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'addFilterRequest';
     ...
     * Sets type
     *
     * @param FilterType $type The type of filter to create
     *
     * @return self
     */
