...
/**
 * ActivityTypeBulkDeleteResponseAllOfData Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v1
 * @author   OpenAPI Generator team
...
class ActivityTypeBulkDeleteResponseAllOfData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ActivityTypeBulkDeleteResponse_allOf_data';
     ...
     * Sets id
     *
     * @param int[]|null $id The IDs of the deleted activity types
     *
     * @return self
     */
