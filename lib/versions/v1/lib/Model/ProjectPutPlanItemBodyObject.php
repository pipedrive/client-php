...
/**
 * ProjectPutPlanItemBodyObject Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v1
 * @author   OpenAPI Generator team
 ...
 */
class ProjectPutPlanItemBodyObject implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProjectPutPlanItemBodyObject';
     ...
     * Sets phase_id
     *
     * @param float|null $phase_id The ID of a phase on a project board
     *
     * @return self
     */
     ...
     * Sets group_id
     *
     * @param float|null $group_id The ID of a group on a project board
     *
     * @return self
     */
