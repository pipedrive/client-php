...
/**
 * FieldCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v1
 * @author   OpenAPI Generator team
 ...
 */
class FieldCreateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FieldCreateRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['add_visible_flag'] = $data['add_visible_flag'] ?? true;
     ...
     *
     * @param bool|null $add_visible_flag Whether the field is available in the 'add new' modal or not (both in the web and mobile app)
     *
     * @return self
     */
     ...
     * Gets field_type
     *
     * @return \Pipedrive\versions\v1\Model\FieldTypeAsString
     */
     ...
     * Sets field_type
     *
     * @param \Pipedrive\versions\v1\Model\FieldTypeAsString $field_type field_type
     *
     * @return self
     */
