...
/**
 * ActivityPutObjectAllOf Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v1
 * @author   OpenAPI Generator team
...
class ActivityPutObjectAllOf implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ActivityPutObject_allOf';
     ...
     * Sets participants
     *
     * @param object[]|null $participants List of multiple persons (participants) this activity is associated with. It requires a structure as follows: `[{\"person_id\":1,\"primary_flag\":true}]`
     *
     * @return self
     */
     ...
     * Sets done
     *
     * @param \Pipedrive\versions\v1\Model\NumberBoolean|null $done Whether the activity is done or not. 0 = Not done, 1 = Done
     *
     * @return self
     */
