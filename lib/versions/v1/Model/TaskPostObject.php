...
/**
 * TaskPostObject Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v1
 * @author   OpenAPI Generator team
 ...
 */
class TaskPostObject implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TaskPostObject';
     ...
     * Sets project_id
     *
     * @param float $project_id The ID of a project
     *
     * @return self
     */
    ...
    public function setAssigneeIds($assignee_ids): self
    {
        ...
        if (!is_null($assignee_ids) && (count($assignee_ids) > 10)) {
            throw new \InvalidArgumentException('invalid value for $assignee_ids when calling TaskPostObject., number of items must be less than or equal to 10.');
        }
