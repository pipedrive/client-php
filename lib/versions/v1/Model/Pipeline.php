...
class Pipeline implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'name' => 'string',
        'deal_probability' => '\Pipedrive\versions\v1\Model\NumberBoolean',
        'order_nr' => 'int',
        'active' => '\Pipedrive\versions\v1\Model\NumberBoolean'
    ];
     ...
     *
     * @param \Pipedrive\versions\v1\Model\NumberBoolean|null $deal_probability Whether deal probability is disabled or enabled for this pipeline
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param \Pipedrive\versions\v1\Model\NumberBoolean|null $active Whether this pipeline will be made inactive (hidden) or active
     *
     * @return self
     */
