...
/**
 * GetStageDeals Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v1
 * @author   OpenAPI Generator team
 ...
 */
class GetStageDeals implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetStageDeals';
     ...
     * Sets data
     *
     * @param \Pipedrive\versions\v1\Model\DealStrict[]|null $data The array of deals
     *
     * @return self
     */
