...
/**
 * FullTaskObject Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v1
 * @author   OpenAPI Generator team
 ...
 */
class FullTaskObject implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FullTaskObject';
    ...
    public function setAssigneeIds($assignee_ids): self
    {
        ...
        if (!is_null($assignee_ids) && (count($assignee_ids) > 10)) {
            throw new \InvalidArgumentException('invalid value for $assignee_ids when calling FullTaskObject., number of items must be less than or equal to 10.');
        }
