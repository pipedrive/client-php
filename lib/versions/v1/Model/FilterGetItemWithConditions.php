...
/**
 * FilterGetItemWithConditions Class Doc Comment
 *
 * @category Class
 ...
 */
class FilterGetItemWithConditions implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FilterGetItemWithConditions';
     ...
     * Sets active_flag
     *
     * @param bool|null $active_flag The active flag of the filter
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param int|null $user_id The owner of the filter
     *
     * @return self
     */
     ...
     * Sets update_time
     *
     * @param string|null $update_time The date and time when the filter was updated
     *
     * @return self
     */
     ...
     * Sets visible_to
     *
     * @param VisibleTo|null $visible_to The visibility group ID of who can see the filter
     *
     * @return self
     */
