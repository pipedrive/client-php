...
class Configuration
{
    ...
    /**
     * User agent of the HTTP request, set to "Pipedrive-SDK-PHP-10.x" by default
     *
     * @var string
     */
    protected string $userAgent = 'Pipedrive-SDK-PHP-10.x';
    ...
    {
        $report  = 'PHP SDK (Pipedrive\versions\v1) Debug Report:' . PHP_EOL;
