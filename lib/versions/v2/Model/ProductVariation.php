...
class ProductVariation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductVariation';
     ...
     * Sets name
     *
     * @param string|null $name The name of the product variation
     *
     * @return self
     */
     ...
     * Sets prices
     *
     * @param object[]|null $prices Array of objects, each containing: product_variation_id (number), currency (string), price (number), cost (number), direct_cost (number) , notes (string)
     *
     * @return self
     */
