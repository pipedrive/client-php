...
/**
 * GetDealsAllOf Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v2
 * @author   OpenAPI Generator team
 ...
 */
class GetDealsAllOf implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetDeals_allOf';
     ...
     * Sets data
     *
     * @param \Pipedrive\versions\v2\Model\DealItem[]|null $data Deals array
     *
     * @return self
     */
