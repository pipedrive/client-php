...
/**
 * ActivityFieldItemUiVisibility Class Doc Comment
 *
 * @category Class
 ...
 */
class ActivityFieldItemUiVisibility implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ActivityFieldItem_ui_visibility';
     ...
     *
     * @param bool|null $details_visible_flag Whether the field is shown in the details view (read-only)
     *
     * @return self
     */
