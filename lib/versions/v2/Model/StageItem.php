 ...
 */
class StageItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'StageItem';
     ...
     * Sets is_deleted
     *
     * @param bool|null $is_deleted Whether the stage is marked as deleted or not
     *
     * @return self
     */
     ...
     * Sets add_time
     *
     * @param string|null $add_time The stage creation time
     *
     * @return self
     */
     ...
     * Sets update_time
     *
     * @param string|null $update_time The stage update time
     *
     * @return self
     */
