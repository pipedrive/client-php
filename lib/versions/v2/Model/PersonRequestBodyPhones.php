...
/**
 * PersonRequestBodyPhones Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v2
 * @author   OpenAPI Generator team
 ...
 */
class PersonRequestBodyPhones implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PersonRequestBody_phones';
     ...
     * Sets label
     *
     * @param bool|null $label The phone number classification label
     *
     * @return self
     */
