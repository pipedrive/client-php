...
class BoardItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BoardItem';
     ...
     * Sets order_nr
     *
     * @param int|null $order_nr The order of the board
     *
     * @return self
     */
     ...
     * Sets add_time
     *
     * @param string|null $add_time The creation date and time of the board in ISO 8601 format
     *
     * @return self
     */
     ...
     * Sets update_time
     *
     * @param string|null $update_time The update date and time of the board in ISO 8601 format
     *
     * @return self
     */
