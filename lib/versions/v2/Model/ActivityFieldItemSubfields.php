...
/**
 * ActivityFieldItemSubfields Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v2
 * @author   OpenAPI Generator team
 ...
 */
class ActivityFieldItemSubfields implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ActivityFieldItem_subfields';
     ...
     * Sets field_code
     *
     * @param string|null $field_code The subfield identifier
     *
     * @return self
     */
     ...
     * Sets field_name
     *
     * @param string|null $field_name The subfield display name
     *
     * @return self
     */
     ...
     * Sets field_type
     *
     * @param string|null $field_type The subfield type
     *
     * @return self
     */
