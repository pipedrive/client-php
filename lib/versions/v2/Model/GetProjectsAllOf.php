...
/**
 * GetProjectsAllOf Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v2
 * @author   OpenAPI Generator team
 ...
 */
class GetProjectsAllOf implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetProjects_allOf';
     ...
     * Sets data
     *
     * @param \Pipedrive\versions\v2\Model\ProjectItem[]|null $data Projects array
     *
     * @return self
     */
