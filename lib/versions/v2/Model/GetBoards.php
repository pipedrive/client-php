 ...
 */
class GetBoards implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetBoards';
     ...
     * Sets data
     *
     * @param \Pipedrive\versions\v2\Model\BoardItem[]|null $data The array of project boards
     *
     * @return self
     */
