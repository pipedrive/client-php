...
/**
 * PersonPostalAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class PersonPostalAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Person_postal_address';
