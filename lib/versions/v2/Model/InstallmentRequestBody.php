...
/**
 * InstallmentRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v2
 * @author   OpenAPI Generator team
 ...
 */
class InstallmentRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InstallmentRequestBody';
     ...
     * Sets description
     *
     * @param string|null $description The name of the installment.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount The installment amount. Must be a positive number (excluding 0).
     *
     * @return self
     */
