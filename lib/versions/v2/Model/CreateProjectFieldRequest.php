...
/**
 * CreateProjectFieldRequest Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v2
 * @author   OpenAPI Generator team
 ...
 */
class CreateProjectFieldRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CreateProjectFieldRequest';
    ...
    public function setFieldName($field_name): self
    {
        if ((mb_strlen($field_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $field_name when calling CreateProjectFieldRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($field_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $field_name when calling CreateProjectFieldRequest., must be bigger than or equal to 1.');
        }
