...
/**
 * CreateManyDealProductRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v2
 * @author   OpenAPI Generator team
 ...
 */
class CreateManyDealProductRequestBody implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CreateManyDealProductRequestBody';
    ...
    protected static array $openAPITypes = [
        'data' => '\Pipedrive\versions\v2\Model\NewDealProductRequestBody[]'
    ];
     ...
     * Gets data
     *
     * @return \Pipedrive\versions\v2\Model\NewDealProductRequestBody[]
     */
    ...
    public function setData($data): self
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling CreateManyDealProductRequestBody., number of items must be less than or equal to 100.');
        }
