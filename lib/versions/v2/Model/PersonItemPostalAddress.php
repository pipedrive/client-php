...
/**
 * PersonItemPostalAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class PersonItemPostalAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PersonItem_postal_address';
