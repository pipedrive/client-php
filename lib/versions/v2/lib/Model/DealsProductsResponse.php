...
/**
 * DealsProductsResponse Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v2
 * @author   OpenAPI Generator team
 ...
 */
class DealsProductsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DealsProductsResponse';
    ...
    protected static array $openAPITypes = [
        'success' => 'bool',
        'data' => '\Pipedrive\versions\v2\Model\BaseDealProduct[]',
     ...
     * Gets data
     *
     * @return \Pipedrive\versions\v2\Model\BaseDealProduct[]|null
     */
     ...
     * Sets data
     *
     * @param \Pipedrive\versions\v2\Model\BaseDealProduct[]|null $data Array containing data for all products attached to deals
     *
     * @return self
     */
