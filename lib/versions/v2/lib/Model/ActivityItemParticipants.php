...
/**
 * ActivityItemParticipants Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v2
 * @author   OpenAPI Generator team
 ...
 */
class ActivityItemParticipants implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ActivityItem_participants';
     ...
     * Sets primary
     *
     * @param bool|null $primary Whether the person is the primary participant or not
     *
     * @return self
     */
