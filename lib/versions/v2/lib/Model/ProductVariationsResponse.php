...
/**
 * ProductVariationsResponse Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive\versions\v2
 * @author   OpenAPI Generator team
 ...
 */
class ProductVariationsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductVariationsResponse';
    ...
    protected static array $openAPITypes = [
        'success' => 'bool',
        'data' => '\Pipedrive\versions\v2\Model\ProductVariation[]',
     ...
     * Gets data
     *
     * @return \Pipedrive\versions\v2\Model\ProductVariation[]|null
     */
     ...
     * Sets data
     *
     * @param \Pipedrive\versions\v2\Model\ProductVariation[]|null $data Array containing data for all products
     *
     * @return self
     */
