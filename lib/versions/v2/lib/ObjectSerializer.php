...
use Pipedrive\versions\v2\Model\ModelInterface;
...
class ObjectSerializer
{
     ...
     *
     * @param array<mixed>  $collection                 collection to serialize to a string
     ...
     * @param array<string, string>|array<array<string>>|null     $httpHeaders   HTTP headers
     *
    ...
    public static function deserialize($data, string $class, array $httpHeaders = null)
    {
        ...
        if ($class === '\SplFileObject') {
            ...
            // determine file name
            if (is_array($httpHeaders) && array_key_exists('Content-Disposition', $httpHeaders) && is_string($httpHeaders['Content-Disposition']) &&
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Pipedrive\versions\v2\Model\\' . $data->{$discriminator};
