...
class ProductsApi
{
    ...
    {
        list($response) = $this->duplicateProductWithHttpInfo($id);
        return $response;
    }
     ...
     * @return array<mixed> of \Pipedrive\versions\v2\Model\ProductResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function duplicateProductWithHttpInfo($id)
    {
        $request = $this->duplicateProductRequest($id);
     ...
     * @return PromiseInterface
     */
    public function duplicateProductAsync($id): PromiseInterface
    {
        return $this->duplicateProductAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function duplicateProductAsyncWithHttpInfo($id): PromiseInterface
    {
        $returnType = '\Pipedrive\versions\v2\Model\ProductResponse';
        $request = $this->duplicateProductRequest($id);
     ...
     * @return Request
     */
    public function duplicateProductRequest($id): Request
    {
        // verify the required parameter 'id' is set
        /* @phpstan-ignore-next-line */
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling duplicateProduct'
            );
        }

        $resourcePath = '/products/{id}/duplicate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
