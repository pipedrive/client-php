...
class StagesApi
{
     ...
     * Add a new stage
     *
     * @param  \Pipedrive\Model\Stage|null $stage stage (optional)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\GetAddUpdateStage
     */
     ...
     * Add a new stage
     *
     * @param  \Pipedrive\Model\Stage|null $stage (optional)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\GetAddUpdateStage, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    if ('\Pipedrive\Model\GetAddUpdateStage' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\GetAddUpdateStage', []),
    ...
    {
        $returnType = '\Pipedrive\Model\GetAddUpdateStage';
        $request = $this->addStageRequest($stage);
     ...
     *
     * @param  int $id The ID of the stage (required)
     * @param  \Pipedrive\Model\NumberBoolean|null $everyone If &#x60;everyone&#x3D;1&#x60; is provided, deals summary will return deals owned by every user (optional)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\GetOneStage
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\GetOneStage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStageWithHttpInfo($id, $everyone = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    /* @phpstan-ignore-next-line */
                    if ('\Pipedrive\Model\GetOneStage' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\GetOneStage', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    {
        $returnType = '\Pipedrive\Model\GetOneStage';
        $request = $this->getStageRequest($id, $everyone);
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\GetStages
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\GetStages, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStagesWithHttpInfo($pipeline_id = null, $start = 0, $limit = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    /* @phpstan-ignore-next-line */
                    if ('\Pipedrive\Model\GetStages' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\GetStages', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    {
        $returnType = '\Pipedrive\Model\GetStages';
        $request = $this->getStagesRequest($pipeline_id, $start, $limit);
     ...
     *
     * @param  int $id The ID of the stage (required)
     * @param  \Pipedrive\Model\UpdateStageRequest|null $update_stage_request update_stage_request (optional)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\GetAddUpdateStage
     ...
     *
     * @param  int $id The ID of the stage (required)
     * @param  \Pipedrive\Model\UpdateStageRequest|null $update_stage_request (optional)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\GetAddUpdateStage, HTTP status code, HTTP response headers (array of strings)
