...
class ItemSearchApi
{
     ...
     * @return \Pipedrive\Model\ItemSearchResponse
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\ItemSearchResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    if ('\Pipedrive\Model\ItemSearchResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\ItemSearchResponse', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Pipedrive\Model\ItemSearchResponse',
    ...
    {
        $returnType = '\Pipedrive\Model\ItemSearchResponse';
        $request = $this->searchItemRequest($term, $item_types, $fields, $search_for_related_items, $exact_match, $include_fields, $start, $limit);
     ...
     * @param  string $field_key The key of the field to search from. The field key can be obtained by fetching the list of the fields using any of the fields&#39; API GET methods (dealFields, personFields, etc.). (required)
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\ItemSearchFieldResponse
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\ItemSearchFieldResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchItemByFieldWithHttpInfo($term, $field_type, $field_key, $exact_match = false, $return_item_ids = null, $start = null, $limit = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    /* @phpstan-ignore-next-line */
                    if ('\Pipedrive\Model\ItemSearchFieldResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\ItemSearchFieldResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Pipedrive\Model\ItemSearchFieldResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\Pipedrive\Model\ItemSearchFieldResponse';
        $request = $this->searchItemByFieldRequest($term, $field_type, $field_key, $exact_match, $return_item_ids, $start, $limit);
