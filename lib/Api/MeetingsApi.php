...
class MeetingsApi
{
     ...
     * @return \Pipedrive\Model\UserProviderLinkSuccessResponse|\Pipedrive\Model\UserProviderLinkErrorResponse|\Pipedrive\Model\UserProviderLinkErrorResponse
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\UserProviderLinkSuccessResponse|\Pipedrive\Model\UserProviderLinkErrorResponse|\Pipedrive\Model\UserProviderLinkErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    if ('\Pipedrive\Model\UserProviderLinkSuccessResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\UserProviderLinkSuccessResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    /* @phpstan-ignore-next-line */
                    if ('\Pipedrive\Model\UserProviderLinkErrorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\UserProviderLinkErrorResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Pipedrive\Model\UserProviderLinkSuccessResponse',
                ...
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Pipedrive\Model\UserProviderLinkErrorResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\Pipedrive\Model\UserProviderLinkSuccessResponse';
        $request = $this->deleteUserProviderLinkRequest($id);
     ...
     *
     * @param  \Pipedrive\Model\UserProviderLinkCreateRequest|null $user_provider_link_create_request user_provider_link_create_request (optional)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\UserProviderLinkSuccessResponse|\Pipedrive\Model\UserProviderLinkErrorResponse
     */
     ...
     * Link a user with the installed video call integration
     *
     * @param  \Pipedrive\Model\UserProviderLinkCreateRequest|null $user_provider_link_create_request (optional)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\UserProviderLinkSuccessResponse|\Pipedrive\Model\UserProviderLinkErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
