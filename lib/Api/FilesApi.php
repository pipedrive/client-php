...
class FilesApi
{
     ...
     * @return \Pipedrive\Model\AddFile
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\AddFile, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    if ('\Pipedrive\Model\AddFile' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\AddFile', []),
    ...
    {
        $returnType = '\Pipedrive\Model\AddFile';
        $request = $this->addFileRequest($file, $deal_id, $person_id, $org_id, $product_id, $activity_id, $lead_id);
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\CreateRemoteFileAndLinkItToItem, HTTP status code, HTTP response headers (array of strings)
     */
    public function addFileAndLinkItWithHttpInfo($file_type, $title, $item_type, $item_id, $remote_location)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    /* @phpstan-ignore-next-line */
                    if ('\Pipedrive\Model\CreateRemoteFileAndLinkItToItem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\CreateRemoteFileAndLinkItToItem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    {
        $returnType = '\Pipedrive\Model\CreateRemoteFileAndLinkItToItem';
        $request = $this->addFileAndLinkItRequest($file_type, $title, $item_type, $item_id, $remote_location);
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\DeleteFile
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\DeleteFile, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteFileWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    /* @phpstan-ignore-next-line */
                    if ('\Pipedrive\Model\DeleteFile' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\DeleteFile', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    {
        $returnType = '\Pipedrive\Model\DeleteFile';
        $request = $this->deleteFileRequest($id);
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\GetOneFile
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\GetOneFile, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFileWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    /* @phpstan-ignore-next-line */
                    if ('\Pipedrive\Model\GetOneFile' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\GetOneFile', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    {
        $returnType = '\Pipedrive\Model\GetOneFile';
        $request = $this->getFileRequest($id);
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\GetAllFiles
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\GetAllFiles, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFilesWithHttpInfo($start = 0, $limit = null, $sort = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    /* @phpstan-ignore-next-line */
                    if ('\Pipedrive\Model\GetAllFiles' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\GetAllFiles', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    {
        $returnType = '\Pipedrive\Model\GetAllFiles';
        $request = $this->getFilesRequest($start, $limit, $sort);
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\LinkRemoteFileToItem
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\LinkRemoteFileToItem, HTTP status code, HTTP response headers (array of strings)
     */
    public function linkFileToItemWithHttpInfo($item_type, $item_id, $remote_id, $remote_location)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    /* @phpstan-ignore-next-line */
                    if ('\Pipedrive\Model\LinkRemoteFileToItem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\LinkRemoteFileToItem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    {
        $returnType = '\Pipedrive\Model\LinkRemoteFileToItem';
        $request = $this->linkFileToItemRequest($item_type, $item_id, $remote_id, $remote_location);
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return \Pipedrive\Model\UpdateFile
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\UpdateFile, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateFileWithHttpInfo($id, $name = null, $description = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    /* @phpstan-ignore-next-line */
                    if ('\Pipedrive\Model\UpdateFile' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\UpdateFile', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    {
        $returnType = '\Pipedrive\Model\UpdateFile';
        $request = $this->updateFileRequest($id, $name, $description);
