...
class BillingApi
{
     ...
     * @return \Pipedrive\Model\SubscriptionAddonsResponse
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\SubscriptionAddonsResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    if ('\Pipedrive\Model\SubscriptionAddonsResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\SubscriptionAddonsResponse', []),
    ...
    {
        $returnType = '\Pipedrive\Model\SubscriptionAddonsResponse';
        $request = $this->getCompanyAddonsRequest();
