...
class UserSettingsApi
{
     ...
     * @return \Pipedrive\Model\UserSettings|\Pipedrive\Model\Unauthorized
     */
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException|GuzzleException
     * @return array<mixed> of \Pipedrive\Model\UserSettings|\Pipedrive\Model\Unauthorized, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    if ('\Pipedrive\Model\UserSettings' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Pipedrive\Model\UserSettings', []),
    ...
    {
        $returnType = '\Pipedrive\Model\UserSettings';
        $request = $this->getUserSettingsRequest();
