 ...
 */
class Unauthorized implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'unauthorized';
     ...
     * Sets error_code
     *
     * @param int|null $error_code The response error code
     *
     * @return self
     */
