 ...
 */
class FieldUpdateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FieldUpdateRequest';
     ...
     *
     * @param bool|null $add_visible_flag Whether the field is available in 'add new' modal or not (both in web and mobile app)
     *
     * @return self
     */
