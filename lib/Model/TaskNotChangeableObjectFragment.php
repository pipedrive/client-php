...
/**
 * TaskNotChangeableObjectFragment Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive
 * @author   OpenAPI Generator team
 ...
 */
class TaskNotChangeableObjectFragment implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TaskNotChangeableObjectFragment';
