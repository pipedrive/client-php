...
/**
 * ActivityTypeUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive
 * @author   OpenAPI Generator team
 ...
 */
class ActivityTypeUpdateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ActivityTypeUpdateRequest';
     ...
     * Sets order_nr
     *
     * @param int|null $order_nr An order number for this activity type. Order numbers should be used to order the types in the activity type selections.
     *
     * @return self
     */
