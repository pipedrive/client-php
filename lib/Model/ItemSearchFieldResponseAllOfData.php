...
/**
 * ItemSearchFieldResponseAllOfData Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive
 * @author   OpenAPI Generator team
 ...
 */
class ItemSearchFieldResponseAllOfData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemSearchFieldResponse_allOf_data';
     ...
     * Sets field_key
     *
     * @param mixed|null $field_key The value of the searched `field_key`
     *
     * @return self
     */
