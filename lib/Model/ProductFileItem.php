...
/**
 * ProductFileItem Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductFileItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductFileItem';
     ...
     * Sets product_id
     *
     * @param int|null $product_id The ID of the product associated with the file
     *
     * @return self
     */
     ...
     * Sets add_time
     *
     * @param string|null $add_time The UTC date time when the file was uploaded. Format: YYYY-MM-DD HH:MM:SS
     *
     * @return self
     */
     ...
     * Sets update_time
     *
     * @param string|null $update_time The UTC date time when the file was last updated. Format: YYYY-MM-DD HH:MM:SS
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL to download the file
     *
     * @return self
     */
