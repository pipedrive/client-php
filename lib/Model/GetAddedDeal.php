...
/**
 * GetAddedDeal Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive
 * @author   OpenAPI Generator team
 ...
 */
class GetAddedDeal implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetAddedDeal';
     ...
     * Sets data
     *
     * @param \Pipedrive\Model\DealNonStrict|null $data data
     *
     * @return self
     */
