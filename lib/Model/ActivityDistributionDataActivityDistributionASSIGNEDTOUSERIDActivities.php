...
/**
 * ActivityDistributionDataActivityDistributionASSIGNEDTOUSERIDActivities Class Doc Comment
 *
 * @category Class
...
class ActivityDistributionDataActivityDistributionASSIGNEDTOUSERIDActivities implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ActivityDistributionData_activity_distribution_ASSIGNED_TO_USER_ID_activities';
    ...
    {
        $this->container['activity_type_name'] = $data['activity_type_name'] ?? null;
    }
     ...
     *
     * @param int|null $activity_type_name The count of activities related to a specific type
     *
     * @return self
     */
    public function setActivityTypeName($activity_type_name): self
    {
