 ...
 */
class ProductsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductsResponse';
     ...
     * Gets data
     *
     * @return \Pipedrive\Model\ProductResponse[]|null
     */
     ...
     * Sets data
     *
     * @param \Pipedrive\Model\ProductResponse[]|null $data Array containing data for all products
     *
     * @return self
     */
