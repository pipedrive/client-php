...
/**
 * GetDealsSummaryDataWeightedValuesTotal Class Doc Comment
 *
 * @category Class
 ...
 */
class GetDealsSummaryDataWeightedValuesTotal implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetDealsSummary_data_weighted_values_total';
     ...
     * Sets value
     *
     * @param float|null $value The total weighted value of the deals in the deal currency group
     *
     * @return self
     */
     ...
     *
     * @param string|null $value_formatted The total weighted value of the deals formatted with deal currency. E.g. €50
     *
     * @return self
     */
