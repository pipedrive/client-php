...
class Params implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets pipeline_id
     *
     * @param int[]|null $pipeline_id The IDs of pipelines of the goal
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $activity_type_id The IDs of activity types of the goal
     *
     * @return self
     */
    public function setActivityTypeId($activity_type_id): self
    {
