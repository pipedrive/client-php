...
/**
 * OrganizationRelationship Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive
 * @author   OpenAPI Generator team
 ...
 */
class OrganizationRelationship implements ModelInterface, ArrayAccess, JsonSerializable
{
    use RawData;
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrganizationRelationship';
     ...
     * Sets type
     *
     * @param string|null $type The type of organization relationship
     *
     * @return self
     */
     ...
     *
     * @param int|null $rel_owner_org_id The owner of this relationship. If type is `parent`, then the owner is the parent and the linked organization is the daughter.
     *
     * @return self
     */
     ...
     *
     * @param int|null $rel_linked_org_id The linked organization in this relationship. If type is `parent`, then the linked organization is the daughter.
     *
     * @return self
     */
