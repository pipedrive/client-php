...
/**
 * ProductWithObjectPrices Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive
 * @author   OpenAPI Generator team
 ...
 */
class ProductWithObjectPrices implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductWithObjectPrices';
     ...
     * Sets prices
     *
     * @param object|null $prices Object of objects, each containing: currency (string), price (number), cost (number, optional), overhead_cost (number, optional)
     *
     * @return self
     */
