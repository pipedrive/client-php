...
/**
 * PictureDataWithValue Class Doc Comment
 *
 * @category Class
 * @package  Pipedrive
 * @author   OpenAPI Generator team
 ...
 */
class PictureDataWithValue implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PictureDataWithValue';
     ...
     * Sets value
     *
     * @param int|null $value The ID of the picture associated with the item
     *
     * @return self
     */
