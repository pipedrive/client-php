...
class Client
{
    ...
    /**
     * Singleton access to ItemsSearch controller
     * @return Controllers\ItemsSearchController The *Singleton* instance
     */
    public function getItemsSearch()
    {
        return Controllers\ItemsSearchController::getInstance();
    }
    /**
