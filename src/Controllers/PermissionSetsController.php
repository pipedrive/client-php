...
{
    /**
     * @var PermissionSetsController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return PermissionSetsController The *Singleton* instance.
     */
    ...
    public function getAllPermissionSets()
    {
        ...
        if ($response->code == 404) {
            throw new APIException('If the User ID has no assignments, then it will return NotFound', $_httpContext);
        }
     ...
     *
     * @param integer $id ID of the permission set
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getOnePermissionSet(
        $id
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
        ...
        //prepare query string for API call
        $_queryBuilder = '/permissionSets/{id}';
    ...
    public function listPermissionSetAssignments(
        ...
        //prepare query string for API call
        $_queryBuilder = '/permissionSets/{id}/assignments';
