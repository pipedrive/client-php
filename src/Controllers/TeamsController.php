...
{
    /**
     * @var TeamsController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return TeamsController The *Singleton* instance.
     */
     ...
     * @param string $options['orderBy']    (optional) Field name to sort returned teams by
     * @param int    $options['skipUsers']  (optional) When enabled, the teams will not include IDs of member users
    ...
    public function getAllTeams(
        ...
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array (
            'order_by'   => $this->val($options, 'orderBy', Models\OrderByEnum::ID),
            'skip_users' => $this->val($options, 'skipUsers'),
        ));
     ...
     *
     * @param  array  $options    Array with all options for search
     * @param string  $options['name']        The Team name
     * @param integer $options['managerId']   The Team manager ID
     * @param string  $options['description'] (optional) The Team description
     * @param array   $options['users']       (optional) IDs of the Users that belong to the Team
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function addANewTeam(
        $options
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
        ...
        $_parameters = array (
            ...
            'manager_id'  => $this->val($options, 'managerId'),
            'description' => $this->val($options, 'description'),
            'users'     => array_values($this->val($options, 'users'))
        );
     ...
     *
     * @param  array  $options    Array with all options for search
     * @param integer $options['id']         ID of the team
     * @param int     $options['skipUsers']  (optional) When enabled, the teams will not include IDs of member users
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getASingleTeam(
        $options
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getAllUsersInATeam(
        $id
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
     ...
     * @param  array  $options    Array with all options for search
     * @param integer $options['id']    ID of the team
     * @param array   $options['users'] List of User IDs
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function addUsersToATeam(
        $options
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteUsersFromATeam(
        $options
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getAllTeamsOfAUser(
        $options
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
