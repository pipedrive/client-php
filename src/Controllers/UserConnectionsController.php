 ...
 */
class UserConnectionsController extends BaseController
{
    /**
     * @var UserConnectionsController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return UserConnectionsController The *Singleton* instance.
     */
