...
{
    /**
     * @var MailMessagesController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return MailMessagesController The *Singleton* instance.
     */
     ...
     * @param integer $options['id']           ID of the mail message to fetch.
     * @param int     $options['includeBody']  (optional) Whether to include full message body or not. 0 = Don't
     *                                         include, 1 = Include
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getOneMailMessage(
        $options
    ) {
        ...
        $_queryBuilder = '/mailbox/mailMessages/{id}';
        ...
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array (
            'include_body' => $this->val($options, 'includeBody'),
        ));
