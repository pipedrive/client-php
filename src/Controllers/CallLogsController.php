...
class CallLogsController extends BaseController
{
    ...
    public function addACallLog(
        ...
        return $mapper->mapClass($response->body, 'Pipedrive\\Models\\GetAddedCallLog');
    }
    ...
    public function deleteACallLog(
        ...
        return $mapper->mapClass($response->body, 'Pipedrive\\Models\\DeleteCallLog');
    }
    ...
    public function getDetailsOfACallLog(
        ...
        return $mapper->mapClass($response->body, 'Pipedrive\\Models\\GetCallLog');
    }
