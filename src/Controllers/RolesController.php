...
{
    /**
     * @var RolesController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return RolesController The *Singleton* instance.
     */
     ...
     *
     * @param  array  $options    Array with all options for search
     * @param integer $options['id']             ID of the role
     * @param integer $options['parentRoleId']   (optional) The ID of the parent Role
     * @param string  $options['name']           (optional) The name of the Role
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateRoleDetails(
        ...
        //prepare parameters
        $_parameters = array (
            'parent_role_id' => $this->val($options, 'parentRoleId'),
    ...
    public function deleteARoleAssignment(
        ...
        //prepare query string for API call
        $_queryBuilder = '/roles/{id}/assignments';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listRoleSubRoles(
        $options
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
     ...
     * @throws APIException Thrown if API call fails
     */
    public function listRoleSettings(
        $id
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
        ...
        //prepare query string for API call
        $_queryBuilder = '/roles/{id}/settings';
     ...
     * @param  array  $options    Array with all options for search
     * @param integer $options['id']          ID of the role
     * @param string  $options['settingKey']  TODO: type description here
     * @param int     $options['value']       Possible values for default_visibility settings: 0...1.
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function addOrUpdateRoleSetting(
        $options
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
        ...
        //prepare parameters
        $_parameters = array (
            'setting_key' => APIHelper::prepareFormFields($this->val($options, 'settingKey')),
