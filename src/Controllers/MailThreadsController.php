 ...
 */
class MailThreadsController extends BaseController
{
    /**
     * @var MailThreadsController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return MailThreadsController The *Singleton* instance.
     */
     ...
     * @param string  $options['folder'] Type of folder to fetch.
    ...
    public function getMailThreads(
        ...
        $_queryBuilder = '/mailbox/mailThreads';

        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array (
            'folder' => $this->val($options, 'folder'),
     ...
     *
     * @param integer $id ID of the mail thread
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function deleteMailThread(
        $id
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
        ...
        //prepare query string for API call
        $_queryBuilder = '/mailbox/mailThreads/{id}';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getOneMailThread(
        $id
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
     ...
     *
     * @param  array  $options    Array with all options for search
     * @param integer $options['id']            ID of the mail thread
     * @param integer $options['dealId']        (optional) ID of the deal this thread is associated with
     * @param int     $options['sharedFlag']    (optional) TODO: type description here
     * @param int     $options['readFlag']      (optional) TODO: type description here
     * @param int     $options['archivedFlag']  (optional) TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateMailThreadDetails(
        $options
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
        ...
        $_parameters = array (
            ...
            'shared_flag' => APIHelper::prepareFormFields($this->val($options, 'sharedFlag')),
            'read_flag'   => APIHelper::prepareFormFields($this->val($options, 'readFlag')),
            'archived_flag' => APIHelper::prepareFormFields($this->val($options, 'archivedFlag'))
        );
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getAllMailMessagesOfMailThread(
        $id
    ) {
        //check or get oauth token
        OAuthManager::getInstance()->checkAuthorization();
        ...
        //prepare query string for API call
        $_queryBuilder = '/mailbox/mailThreads/{id}/mailMessages';
